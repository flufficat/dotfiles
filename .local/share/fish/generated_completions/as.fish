...
complete -c as -s D -d 'X Item "-D" Ignored'
...
complete -c as -l emulation -d 'X Item "--emulation=name" This option was formerly used to switch between ELF…'
...
complete -c as -o mspe -d 'X Item "-mspe" Generate code for Motorola SPE instructions'
