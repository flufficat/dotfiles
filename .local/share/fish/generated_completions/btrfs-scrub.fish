...
complete -c btrfs-scrub -s c -d 'set IO priority class (see ionice(1) manpage) if the IO scheduler configured …'
...
complete -c btrfs-scrub -l tbytes -d 'show sizes in TiB, or TB with --si A status on a filesystem without any error…'
