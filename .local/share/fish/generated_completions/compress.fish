...
complete -c compress -s k -d 'option makes compress/uncompress keep the input files instead of automaticall…'
complete -c compress -s c -d 'option makes compress/uncompress write to the standard output; no files are c…'
