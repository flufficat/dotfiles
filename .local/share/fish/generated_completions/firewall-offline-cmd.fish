...
complete -c firewall-offline-cmd -s h -l help -d 'Prints a short help text and exits'
...
complete -c firewall-offline-cmd -l reset-to-defaults -d 'Reset configuration to firewalld\\*(Aqs default configuration'
