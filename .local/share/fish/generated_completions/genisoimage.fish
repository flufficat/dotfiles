...
complete -c genisoimage -o appid -d 'Specifies a text string that will be written into the volume header'
...
complete -c genisoimage -o eltorito-boot -d 'Specifies the path and filename of the boot image to be used when making an E…'
...
complete -c genisoimage -o cdrecord-params -d 'This option is needed to create a CD Extra or the image of a second session o…'
complete -c genisoimage -o eltorito-catalog -d 'Specifies the path and filename of the boot catalog, which is required for an…'
...
complete -c genisoimage -o checksum_algorithm_iso -d 'Specify the checksum types desired for the output image'
complete -c genisoimage -o checksum_algorithm_template -d 'Specify the checksum types desired for the output jigdo template'
complete -c genisoimage -o copyright -d 'Specifies copyright information, typically a filename on the disc'
complete -c genisoimage -o omit-period -d 'Do not append a period to files that do not have one'
complete -c genisoimage -o disable-deep-relocation -d 'Do not use deep directory relocation, and instead just pack them in the way w…'
complete -c genisoimage -o debug -d 'Set debug flag'
...
complete -c genisoimage -o efi-boot -d 'Set EFI boot image name'
complete -c genisoimage -o follow-links -d 'Follow symbolic links when generating the filesystem'
...
complete -c genisoimage -o full-iso9660-filenames -d 'Allow full 31-character filenames'
...
complete -c genisoimage -o omit-version-number -d 'Omit version numbers from ISO9660 filenames'
...
complete -c genisoimage -o preparer -d 'Specifies a text string that will be written into the volume header'
...
complete -c genisoimage -o rock -d 'Generate SUSP and RR records using the Rock Ridge protocol to further describ…'
complete -c genisoimage -o rational-rock -d 'This is like the -R option, but file ownership and modes are set to more usef…'
...
complete -c genisoimage -o sectype -d 'Set output sector type to e. g.  data/xa1/raw'
...
complete -c genisoimage -o translation-table -d 'Generate a file  TRANS'
...
complete -c genisoimage -o untranslated-filenames -d 'Allows "untranslated" filenames, completely violating the ISO9660 standards d…'
...
complete -c genisoimage -o verbose -d 'Verbose execution'
complete -c genisoimage -s x -d 'Identical to  -m R glob '
complete -c genisoimage -o XA -d 'Generate XA directory attruibutes'
complete -c genisoimage -o xa -d 'Generate rationalized XA directory attruibutes'
complete -c genisoimage -s A
...
complete -c genisoimage -s b
complete -c genisoimage -s C
complete -c genisoimage -s M -d 'genisoimage will create a filesystem image that is intended to be a continuat…'
complete -c genisoimage -s c
complete -c genisoimage -s d
complete -c genisoimage -s D
complete -c genisoimage -s e
complete -c genisoimage -s f
complete -c genisoimage -s l
complete -c genisoimage -s N -d 'as the extra name space is taken from the space reserved for file version num…'
complete -c genisoimage -o nobak
complete -c genisoimage -s p
complete -c genisoimage -s R
complete -c genisoimage -s r
complete -c genisoimage -s s
complete -c genisoimage -s T
complete -c genisoimage -s U
complete -c genisoimage -s v
complete -c genisoimage -s z
complete -c genisoimage -o transparent-compression -d 'Generate special RRIP records for transparently compressed files'
