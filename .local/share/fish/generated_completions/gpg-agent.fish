...
complete -c gpg-agent -l enable-extended-key-format -d 'TQ   --disable-extended-key-format Since version 2'
...
complete -c gpg-agent -l disable-extended-key-format -d 'Since version 2. 3 keys are created in the extended private key format'
