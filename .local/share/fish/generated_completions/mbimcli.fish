...
complete -c mbimcli -l help-intel-tools -d 'Show Intel 5G tools options . SS "Basic Connect options:"'
...
complete -c mbimcli -l query-fcc-lock -d 'Query FCC lock information'
complete -c mbimcli -l set-fcc-lock -d 'Set FCC lock information . PP Intel 5G tools options'
complete -c mbimcli -l set-trace-config -d 'Set trace configuration'
complete -c mbimcli -l query-trace-config -d 'Query trace configuration . SS "Application Options:"'
