...
complete -c pptp -l missing-window -d 'Enable \'missing window\' validation and set packet tolerance (300=default, 600…'
complete -c pptp -l version -d 'Display version'
